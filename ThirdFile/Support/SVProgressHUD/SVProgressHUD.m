...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:0.8];//[UIColor whiteColor];
        SVProgressHUDForegroundColor = [UIColor whiteColor];//[UIColor blackColor];
        SVProgressHUDCornerRadius = 6;//14;
        ...
        SVProgressHUDInfoImage = nil;//去掉信息图标
