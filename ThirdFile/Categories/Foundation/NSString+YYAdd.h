...
/*
   将中文转换为拼音
 */
- (nullable NSString *)chineseWithString:(NSString *)chinese removeSpaces:(BOOL )spaceBool;

/*
 根据需求
   1、如果Unicode中文，长度占用2个字节，英文字符占用1个字节
   2、如果使用UTF-8，就用系统默认方法lengthOfBytesUsingEncoding，判断长度，中文3个长度，英文1个长度
 */
- (NSUInteger )lengthChineseUnicodeOfString:(NSString *)text;
