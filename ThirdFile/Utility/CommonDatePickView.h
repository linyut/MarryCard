...
typedef enum  //日期选择的类型
{
    ...
    kDatePickerTypeNoSecond ,       //包含年，月，日，时，分
    kDatePickerTypeTime,     //只包含时、分
    kDatePickerTypeDate,  //年，月，日
...
UIPickerViewDelegate>
{
    ...
    NSMutableArray *minuteMtbArray; //分
}
...
@property (assign, nonatomic) int currentMinute;  //选择的分
