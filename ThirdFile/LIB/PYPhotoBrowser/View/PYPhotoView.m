...
- (void)setPhoto:(PYPhoto *)photo
{
    ...
    [self sd_setImageWithURL:url placeholderImage:placeholdeerImage options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
        if (self.isBig) {
